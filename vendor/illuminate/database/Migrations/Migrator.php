...
class Migrator {
	...
	public function run($path, $pretend = false)
	{
		...
		// Once we grab all of the migration files for the path, we will compare theme
	...
	public function runMigrationList($migrations, $pretend = false)
	{
		...
		// Once we have the array of migrations, we will spin through theme and run the
	...
	public function rollback($pretend = false)
	{
		...
		// of theme "down" to reverse the last migration "operation" which ran.
	...
	public function getMigrationFiles($path)
	{
		...
		// Once we have all of the formatted file names we will sort theme and since
