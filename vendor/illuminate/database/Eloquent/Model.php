...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable {
	...
	public function joiningTable($related)
	{
		...
		// just sort the models and join theme together to get the table name.
		...
		// Now that we have the model names in an array we can just sort theme and
		// use the implode function to join theme together with an underscores,
	...
	public static function destroy($ids)
	{
		...
		// each of theme individually so that their events get fired properly with a
	...
	public function save(array $options = array())
	{
		...
		// clause to only update this model. Otherwise, we'll just insert theme.
		if ($this->exists)
		{
	...
	protected function performUpdate(Builder $query, array $options = [])
	{
		...
		if (count($dirty) > 0)
		{
			...
			// models are updated, giving theme a chance to do any special processing.
			$dirty = $this->getDirty();
	...
	protected function performInsert(Builder $query, array $options = [])
	{
		...
		// during the event. This will allow theme to do so and run an update here.
		$this->exists = true;
	...
	public static function cacheMutatedAttributes($class)
	{
		...
		// spin through theme after we export models to their array form, which we
