...
class Builder {
	...
	public function chunk($count, callable $callback)
	{
		...
		{
			// On each chunk result set, we will pass theme to the callback and then let the
	...
	public function eagerLoadRelations(array $models)
	{
		...
		{
			// For nested eager loads we'll skip loading theme here and they will be set as an
	...
	protected function nestedRelations($relation)
	{
		...
		// that start with the given top relations and adds theme to our arrays.
		foreach ($this->eagerLoad as $name => $constraints)
		{
