...
class BelongsToMany extends Relation {
	...
	protected function cleanPivotAttributes(Model $model)
	{
		...
		foreach ($model->getAttributes() as $key => $value)
		{
			...
			// theme from the parent's models since they exist in a different table.
	...
	protected function getAliasedPivotColumns()
	{
		...
		// can easily extract theme out of the models and put theme into the pivot
	...
	protected function buildDictionary(Collection $results)
	{
		...
		// of the relation so that we will easily and quickly match theme to their
	...
	/**
	 * Save an array of new models and attach theme to the parent model.
	 *
	 * @param  array  $models
	...
	protected function attachNew(array $records, array $current, $touch = true)
	{
		...
		foreach ($records as $id => $attributes)
		{
			...
			// list of updated pivot records so we return theme back out to the consumer.
	...
	protected function createAttachRecord($id, $timed)
	{
		...
		// theme by calling the parent model's "freshTimestamp" method which will
