...
class BelongsTo extends Relation {
	...
	protected function getEagerModelKeys(array $models)
	{
		...
		// to query for via the eager loading query. We will add theme to an array then
		...
		// be what this developer is expecting in a case where this happens to theme.
		if (count($keys) == 0)
		{
			return array(0);
		}
	...
	public function match(array $models, Collection $results, $relation)
	{
		...
		// the primary key of the children to map theme onto the correct instances.
		foreach ($models as $model)
		{
