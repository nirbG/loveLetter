...
class Grammar extends BaseGrammar {
	...
	protected function compileJoins(Builder $query, $joins)
	{
		...
		foreach ($joins as $join)
		{
			...
			// of these clauses so we will need to iterate through each one and build theme
			// separately, then we'll join theme up into a single string when we're done.
			$clauses = array();
	...
	public function compileInsert(Builder $query, array $values)
	{
		...
		// bindings so we will loop through the record and parameterize theme all.
		$parameters = array();
	...
	public function compileUpdate(Builder $query, $values)
	{
		...
		// and compile theme so we can attach theme to this update, as update queries
