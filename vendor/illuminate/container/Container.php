...
class Container implements ArrayAccess, ContainerContract {
	...
	public function make($abstract, $parameters = [])
	{
		...
		// If we defined any extenders for this type, we'll need to spin through theme
		// and apply theme to the object being built. This allows for the extension
	...
	/**
	 * If extra parameters are passed by numeric ID, rekey theme by argument name.
	 *
	 * @param  array  $dependencies
	 * @param  array  $parameters
	 * @return array
