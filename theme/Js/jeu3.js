                ...
                pr.done(function (d,s,jqXHR) {
                    ...
                    if(d.status!="terminer") {
                        ...
                        for (var z = 1; z < d.joueur.length; z++) {
                            var plateauadv = "<div id='plateauadv" + z + "' class=' col-sm-6 '></div>";
                            ...
                            if (jeux.nbCarte == 2) {
                                for (var i = 0; i < jeux.main.length; i++) {
                                    carte += "<div class='col-sm-2 '><img src='theme/ressource/cartes/Pioche.png'></div>";
                                }
                                cont += "<div id='mainAdv' class='row'>" + score + " " + carte + "</div>";
                            } else {
                                carte += "<div class='col-sm-2 '><img src='theme/ressource/cartes/" + carteAdv + "'></div>";
