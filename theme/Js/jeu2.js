            ...
            var pr=$.ajax('salle'+id+'/load',
                ...
                pr.done(function (d,s,jqXHR) {
                    ...
                    if(d.status!="terminer") {
                        ...
                        var score = "<div class=" + "'col-sm-1 col-sm-offset-4'><h3>Score:" + point + "</h3><p>" + user.pseudo + "</p></div>";
                        var cont = "";
                        var carte = "";
                        if(d.joueur[1].action=="resultat"||d.joueur[1].action=="éliminé"){
                            carteAdv="vide.png";
                        }
                        if (jeux.nbCarte == 2) {
                            for (var i = 0; i < jeux.main.length; i++) {
                                carte += "<div class='col-sm-1 '><img src='theme/ressource/cartes/Pioche.png'></div>";
                            }
                            cont += "<div id='mainAdv' class='row'>" + score + " " + carte + "</div>";
                        } else {
                            carte += "<div class='col-sm-1 '><img src='theme/ressource/cartes/"+carteAdv+"'></div>";
                        ...
                        if (jeux.size != 0) {
                            for (i = 0; i < jeux.size; i++) {
                                cont += "<div class='col-sm-1 '><img data-img='theme/ressource/cartes/" + jeux.plateau[i].image + "' src='theme/ressource/cartes/" + jeux.plateau[i].image + "'> </div>";
                            }
                        } else {
                            cont += "<div class='col-sm-1 center '><img src='theme/ressource/cartes/vide.png'></div>";
                        }
                        cont += "</div>";
                        var nbC = d.pioche;
                        var def="";
                        ...
                        if (nbC == 0) {
                            cont += "<div class='row'>"+tour+"<div id='pioche' class='col-lg-1'><img src='theme/ressource/cartes/vide.png'></div>"+def+"</div>";
                        } else {
                            cont += "<div class='row'>"+tour+"<div id='pioche' class='col-lg-1'><img src='theme/ressource/cartes/Pioche.png'></div>"+def+"</div>";
                        }
                        $("#partie").append(cont);
                        jeux = d.joueur[0];
                        ...
                        cont += "<div id='main' class='row carte'>" + carte + " " + score + "</div>";
                        $("#partie").append(cont);
